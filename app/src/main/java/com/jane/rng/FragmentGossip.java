...
public class FragmentGossip extends Fragment {
    private Timer timer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState){
        return inflater.inflate(R.layout.gossip, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        myLayout = ( LinearLayout ) getView().findViewById ( R.id.quotation) ;

        final TextView gossipTitle = getView().findViewById(R.id.gossipTitle);
